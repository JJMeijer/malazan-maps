...
def home_view(request):
    """Homepage View"""
    header_map_landscape = Map.objects.get(name='Northwest Genabackis')
    header_map_portrait = Map.objects.get(name="Genabackis (GotM)")
    ...
    context = {
        ...
        'header_map_landscape': header_map_landscape,
        'header_map_portrait': header_map_portrait
    }
